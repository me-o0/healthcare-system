...
!(function () {
  ...
  var e = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    l = function (e, t) {
      var n, r, a, i, o, u, c, m;
      e.getParam("insertdatetime_element", !1) ? ((n = s(e, t)), (r = void 0), (r = /%[HMSIp]/.test(t) ? s(e, "%Y-%m-%dT%H:%M") : s(e, "%Y-%m-%d")), (a = e.dom.getParent(e.selection.getStart(), "time")) ? ((o = a), (u = r), (c = n), (m = (i = e).dom.create("time", { datetime: u }, c)), o.parentNode.insertBefore(m, o), i.dom.remove(o), i.selection.select(m, !0), i.selection.collapse(!1)) : e.insertContent('<time datetime="' + r + '">' + n + "</time>")) : e.insertContent(s(e, t));
    },
    t = function (t) {
