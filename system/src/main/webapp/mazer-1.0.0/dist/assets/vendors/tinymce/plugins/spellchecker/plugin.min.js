...
!(function () {
  ...
  var r = function (i, r) {
      ...
      var l = (function u(e) {
        ...
        if (p(e)) return "\n";
        if (((t = ""), (f[e.nodeName] || g[e.nodeName]) && (t += "\n"), (e = e.firstChild))) for (; (t += u(e)), (e = e.nextSibling); );
        return t;
      })(i);
      return {
        text: l,
        ...
        add: function (e, t, n) {
          return a.push({ start: e, end: e + t, text: l.substr(e, t), data: n }), this;
        },
        wrap: function (e) {
          function m(e, t) {
            var n = a[t];
    ...
    T = function (n, e, r, t, o, a) {
      var i,
        ...
        l =
          ((s = n),
          (i = g.map(s.getParam("spellchecker_languages", "English=en,Danish=da,Dutch=nl,Finnish=fi,French=fr_FR,German=de,Italian=it,Polish=pl,Portuguese=pt_BR,Spanish=es,Swedish=sv").split(","), function (e) {
            var t = e.split("=");
