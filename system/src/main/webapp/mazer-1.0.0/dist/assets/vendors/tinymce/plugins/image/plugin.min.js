...
!(function () {
  ...
  var t,
    ...
    oe = function (e, t) {
      return { src: W(t, "src"), alt: re((n = t)) ? "" : W(n, "alt"), title: W(t, "title"), width: Z(t, "width"), height: Z(t, "height"), class: W(t, "class"), style: e(W(t, "style")), caption: $(t), hspace: B(t), vspace: F(t), border: G(t), borderStyle: q(t, "borderStyle"), isDecorative: re(t) };
      var n;
    },
    ...
    ce = function (e, t, n) {
      ...
      le(n, o, t, "caption", function (e, t, n) {
        ...
        (r = n),
        (a = o),
        ((i = t).alt === a.alt && i.isDecorative === a.isDecorative) || se(r, i.alt, i.isDecorative);
    },
    me = function (e, t) {
      ...
      ce(
        ...
        ne(s.parentNode)
          ...
          : (t.selection.select(s),
            ...
            ((o = s).onload = function () {
              i.width || i.height || !_(a) || a.dom.setAttribs(o, { width: String(o.clientWidth), height: String(o.clientHeight) }), l();
            }),
            (o.onerror = l));
    },
  ...
  var Ue = function (e) {
    ...
    Oe = function (r) {
      ...
      return n.then(function (e) {
        return { image: c, imageList: e, classList: i, hasAdvTab: o, hasUploadTab: l, hasUploadUrl: s, hasUploadHandler: u, hasDescription: m, hasImageTitle: d, hasDimensions: g, hasImageCaption: f, url: h, basePath: b, credentials: v, handler: y, prependURL: w, hasAccessibilityOptions: p, automaticUploads: D };
      });
    },
    Ie = function (e) {
      ...
      return x([[{ name: "src", type: "urlinput", filetype: "image", label: "Source" }], t.toArray(), e.hasAccessibilityOptions && e.hasDescription ? [{ type: "label", label: "Accessibility", items: [{ name: "isDecorative", type: "checkbox", label: "Image is decorative" }] }] : [], e.hasDescription ? [n] : [], e.hasImageTitle ? [{ name: "title", type: "input", label: "Image title" }] : [], e.hasDimensions ? [{ name: "dimensions", type: "sizeinput" }] : [], [{ type: "grid", columns: 2, items: x([r.toArray(), e.hasImageCaption ? [{ type: "label", label: "Caption", items: [{ type: "checkbox", name: "caption", label: "Show caption" }] }] : []]) }]]);
    },
    Ne = function (e) {
    ...
    Re = function (e, t) {
      ...
      l !== undefined &&
        ...
        r.hasAccessibilityOptions && (a.isDecorative = i.isDecorative || a.isDecorative || !1),
        r.hasImageTitle && A(i.title) && (a.title = i.title),
        r.hasDimensions && (A(i.width) && (a.dimensions.width = i.width), A(i.height) && (a.dimensions.height = i.height)),
        A(i["class"]) &&
          Te(r.classList, i["class"]).each(function (e) {
            a.classes = e.value;
          }),
        r.hasImageCaption && d(i.caption) && (a.caption = i.caption),
        r.hasAdvTab && (A(i.style) && (a.style = i.style), A(i.vspace) && (a.vspace = i.vspace), A(i.border) && (a.border = i.border), A(i.hspace) && (a.hspace = i.hspace), A(i.borderstyle) && (a.borderstyle = i.borderstyle)),
        t.setData(n));
    },
    ze = function (e, t, n, r) {
    ...
    je = function (h, b, v) {
      return function (e, t) {
        ...
        "src" === t.name
          ...
          ? ((n = h), (r = e), (a = be(Le(b.image), r.getData())), (i = ie(n.normalizeCss, Ee(a, !1))), r.setData({ style: i }))
          : "fileinput" === t.name
          ? ke(h, b, v, e)
    ...
    Be = function (i) {
      return function (e) {
        ...
        return {
          ...
          size: "normal",
          body: (r = e).hasAdvTab || r.hasUploadUrl || r.hasUploadHandler ? { type: "tabpanel", tabs: x([[Ne(r)], r.hasAdvTab ? [Ue(r)] : [], r.hasUploadTab && (r.hasUploadUrl || r.hasUploadHandler) ? [_e(r)] : []]) } : { type: "panel", items: Pe(r) },
          buttons: [
      ...
      var n,
        ...
        s = {
          ...
          createBlobCache: function (e, t, n) {
            return i.editorUpload.blobCache.create({ blob: e, blobUri: t, name: e.name ? e.name.replace(/\.[^\.]+$/, "") : null, filename: e.name, base64: n.split(",")[1] });
          },
          alertErr: function (e) {
            ...
            return (
              ...
              void ((l = de((t = u)))
                ? ((n = oe(function (e) {
                  ...
                  (r = c(c({}, n), e)).src ? pe(t, r) : ((a = t), (i = l) && ((o = a.dom.is(i.parentNode, "figure.image") ? i.parentNode : i), a.dom.remove(o), a.focus(), a.nodeChanged(), a.dom.isEmpty(a.getBody()) && (a.setContent(""), a.selection.setCursorLocation()))))
                : e.src && fe(t, c(c({}, ae()), e)))
            );
            var t, e, n, r, a, i, o, l;
          });
