...
!(function () {
  ...
  var u,
    ...
    k = "All",
    A = { symbols: "Symbols", people: "People", animals_and_nature: "Animals and Nature", food_and_drink: "Food and Drink", activity: "Activity", travel_and_places: "Travel and Places", objects: "Objects", flags: "Flags", user: "User Defined" },
    _ = function (t, n) {
    ...
    x = function (t, n, e) {
      for (
        ...
        ((0 !== n.length &&
          ...
          (r.push({ value: t[u]["char"], text: t[u].title, icon: t[u]["char"] }), !i(r.length)));
        u++
      );
      return r;
    },
    ...
    L = function (o, u) {
      var e,
        ...
        c =
          ((e = function (t) {
            var n, e, r, o, i;
            (e = (n = t).getData()), (r = a.get()), (o = u.listCategory(r)), (i = x(o, e[D], r === k ? h.some(300) : h.none())), n.setData({ results: i });
          }),
          (r = 200),
          (i = null),
          {
      ...
      f.focus(D),
        u.hasLoaded() ||
          ...
          u
            ...
            ["catch"](function (t) {
              f.redial({ title: "Emoticons", body: { type: "panel", items: [{ type: "alertbanner", level: "error", icon: "warning", text: "<p>Could not load emoticons</p>" }] }, buttons: [{ type: "cancel", text: "Close", primary: !0 }], initialData: { pattern: "", results: [] } }), f.focus(D), f.unblock();
            }));
    };
  r.add("emoticons", function (t, n) {
    ...
    (u = g),
      ...
      (i = t).ui.registry.addButton("emoticons", { tooltip: "Emoticons", icon: "emoji", onAction: a }),
      i.ui.registry.addMenuItem("emoticons", { text: "Emoticons...", icon: "emoji", onAction: a }),
      (l = g),
