...
!(function () {
  ...
  var Ae,
    ...
    et = function (e) {
      ...
      return { current: t, version: n, isEdge: r("Edge"), isChrome: r("Chrome"), isIE: r("IE"), isOpera: r("Opera"), isFirefox: r(Ze), isSafari: r("Safari") };
    },
    tt = {
      unknown: function () {
    ...
    ut = function (e) {
      ...
      return { current: t, version: n, isWindows: r(nt), isiOS: r("iOS"), isAndroid: r(rt), isOSX: r("OSX"), isLinux: r("Linux"), isSolaris: r(ot), isFreeBSD: r(it), isChromeOS: r(at) };
    },
    st = {
      unknown: function () {
    ...
    wt = {
      ...
      os: { current: ht.current, version: ht.version, isAndroid: ht.isAndroid, isChromeOS: ht.isChromeOS, isFreeBSD: ht.isFreeBSD, isiOS: ht.isiOS, isLinux: ht.isLinux, isOSX: ht.isOSX, isSolaris: ht.isSolaris, isWindows: ht.isWindows },
    ...
    ur = function (e, t, n) {
      var r,
        ...
        s = e.ownerDocument;
      if (((n = n || e), t)) {
        if (n === e && t.getBoundingClientRect && "static" === er(At.fromDom(e), "position")) return { x: (a = (o = t.getBoundingClientRect()).left + (s.documentElement.scrollLeft || e.scrollLeft) - s.documentElement.clientLeft), y: (u = o.top + (s.documentElement.scrollTop || e.scrollTop) - s.documentElement.clientTop) };
  ...
  var lr = cr.exports.boltExport,
    ...
    wr =
      (Cr([{ bothErrors: ["error1", "error2"] }, { firstError: ["error1", "value2"] }, { secondError: ["value1", "error2"] }, { bothValues: ["value1", "value2"] }]),
      function (e) {
        return e.fold(o, o);
      });
  ...
  function $r(m, p) {
    ...
    var g = 0,
      ...
      n = function (e, t, n) {
        ...
        t && i.passed.push(t), n && i.failed.push(n), 1 !== i.status && (2 !== i.status ? (3 !== i.status ? ((i.status = 1), (a = At.fromTag("link", y.dom)), Yn(a, { rel: "stylesheet", type: "text/css", id: i.id }), (u = Date.now()), p.contentCssCors && Xn(a, "crossOrigin", "anonymous"), p.referrerPolicy && Xn(a, "referrerpolicy", p.referrerPolicy), ((r = a.dom).onload = d), (r.onerror = f), (s = a), fn(on(v), s), Xn(a, "href", o)) : f()) : l());
      },
      o = function (t) {
  ...
  var Gr,
    ...
    Zo = /[<>&\"\']/g,
    ei = /&#([a-z0-9]+);?|&([a-z0-9]+);/gi,
    ti = { 128: "\u20ac", 130: "\u201a", 131: "\u0192", 132: "\u201e", 133: "\u2026", 134: "\u2020", 135: "\u2021", 136: "\u02c6", 137: "\u2030", 138: "\u0160", 139: "\u2039", 140: "\u0152", 142: "\u017d", 145: "\u2018", 146: "\u2019", 147: "\u201c", 148: "\u201d", 149: "\u2022", 150: "\u2013", 151: "\u2014", 152: "\u02dc", 153: "\u2122", 154: "\u0161", 155: "\u203a", 156: "\u0153", 158: "\u017e", 159: "\u0178" },
    ni = { '"': "&quot;", "'": "&#39;", "<": "&lt;", ">": "&gt;", "&": "&amp;", "`": "&#96;" },
    ri = { "&lt;": "<", "&gt;": ">", "&amp;": "&", "&quot;": '"', "&apos;": "'" },
    oi = function (e, t) {
      var n,
    ...
    yi = function (e) {
      var s,
        ...
        a = function (e, t, n) {
          ...
          for (var a = vi(e), u = a.length; u--; ) (o = { attributes: i((r = vi([s, t].join(" ")))), attributesOrder: r, children: i(n, fi) }), (c[a[u]] = o);
        },
        u = function (e, t) {
      ...
      return li[e]
        ...
        : ((s = "id accesskey class dir lang style tabindex title role"),
          ...
          "html4" !== e && ((s += " contenteditable contextmenu draggable dropzone hidden spellcheck translate"), (t += " article aside details dialog figure main header footer hgroup section nav"), (n += " audio canvas command datalist mark meter output picture progress time wbr video ruby bdi keygen")),
          "html5-strict" !== e &&
            ((s += " xml:lang"),
          ...
          "html4" !== e && (u("input button select textarea", "autofocus"), u("input textarea", "placeholder"), u("a", "download"), u("link script img", "crossorigin"), u("img", "loading"), u("iframe", "sandbox seamless allowfullscreen loading")),
  ...
  function Ci(i) {
              ...
              if (
                ...
                for (r = 0, o = (s = vi(s, "|")).length; r < o; r++)
                  if ((i = C.exec(s[r]))) {
                    ...
                    p && ("=" === p && ((a.attributesDefault = a.attributesDefault || []), a.attributesDefault.push({ name: l, value: y }), (u.defaultValue = y)), ":" === p && ((a.attributesForced = a.attributesForced || []), a.attributesForced.push({ name: l, value: y }), (u.forcedValue = y)), "<" === p && (u.validValues = di(y, "?"))), w.test(l) ? ((a.attributePatterns = a.attributePatterns || []), (u.pattern = E(l)), a.attributePatterns.push(u)) : (d[l] || m.push(l), (d[l] = u));
                  }
        ...
        e &&
          ...
          mi(vi(e, ","), function (e) {
            ...
            (u[i] = u[o]),
              ...
              S[i] || ((t = S[o]), delete (t = pi({}, t)).removeEmptyAttrs, delete t.removeEmpty, (S[i] = t)),
              mi(u, function (e, t) {
    ...
    i.valid_elements
      ...
      x("+ol[ul|ol],+ul[ul|ol]"),
      mi({ dd: "dl", dt: "dl", li: "ul ol", td: "tr", th: "tr", tr: "tbody thead tfoot", tbody: "table", thead: "table", tfoot: "table", legend: "fieldset", area: "map", param: "video audio object" }, function (e, t) {
  ...
  var wi = function (e, t, n, r) {
    ...
    Ri = function (e, t) {
      ...
      return (
        ...
        e && ((a = e), Si.test(a.type)) && e.pageX === undefined && e.clientX !== undefined && ((o = (r = s.target.ownerDocument || document).documentElement), (i = r.body), (s.pageX = e.clientX + ((o && o.scrollLeft) || (i && i.scrollLeft) || 0) - ((o && o.clientLeft) || (i && i.clientLeft) || 0)), (s.pageY = e.clientY + ((o && o.scrollTop) || (i && i.scrollTop) || 0) - ((o && o.clientTop) || (i && i.clientTop) || 0))),
        ...
        }) == ((u = s).isDefaultPrevented === ki || u.isDefaultPrevented === Ei) && ((s.isDefaultPrevented = Ei), (s.isPropagationStopped = Ei), (s.isImmediatePropagationStopped = Ei)),
  ...
  var Oi,
    ...
    ba = new RegExp(pa),
    Ca = new RegExp("^" + da + "$"),
    wa = { ID: new RegExp("^#(" + da + ")"), CLASS: new RegExp("^\\.(" + da + ")"), TAG: new RegExp("^(" + da + "|[*])"), ATTR: new RegExp("^" + ma), PSEUDO: new RegExp("^" + pa), CHILD: new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(" + fa + "*(even|odd|(([+-]|)(\\d*)n|)" + fa + "*(?:([+-]|)" + fa + "*(\\d+)|))" + fa + "*\\)|)", "i"), bool: new RegExp("^(?:checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)$", "i"), needsContext: new RegExp("^" + fa + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + fa + "*((?:-\\d)?\\d*)" + fa + "*\\)|)(?=[^-]|$)", "i") },
    ...
    (Ii = Ta.tokenize =
      function (e, t) {
        ...
        for (a = e, u = [], s = Bi.preFilter; a; ) {
          for (i in ((n && !(r = ha.exec(a))) || (r && (a = a.slice(r[0].length) || a), u.push((o = []))), (n = !1), (r = va.exec(a)) && ((n = r.shift()), o.push({ value: n, type: r[0].replace(ga, " ") }), (a = a.slice(n.length))), Bi.filter)) Bi.filter.hasOwnProperty(i) && (!(r = wa[i].exec(a)) || (s[i] && !(r = s[i](r))) || ((n = r.shift()), o.push({ value: n, type: i, matches: r }), (a = a.slice(n.length))));
          if (!n) break;
        }
  ...
  var Ha = document,
    ...
    Ja = function (e, t, n, r) {
      ...
      if (Ya(t)) t = Ga(t, fu(e[0]));
        ...
        if (((t = hu.makeArray(t)), r)) for (o = t.length - 1; 0 <= o; o--) Ja(e, t[o], n, r);
  ...
  (au.fn = au.prototype =
    {
      ...
      add: function (e, t) {
        ...
        if (!1 !== t) for (n = hu.unique(this.toArray().concat(hu.makeArray(e))), this.length = n.length, r = 0; r < n.length; r++) this[r] = n[r];
  ...
  function Nu(a, u) {
    ...
    var r = {},
      ...
      S = function (e) {
        var t, n;
        return (e = g(e)), (t = x(e, "width")), (n = x(e, "height")), -1 === t.indexOf("px") && (t = 0), -1 === n.indexOf("px") && (n = 0), { w: parseInt(t, 10) || e.offsetWidth || e.clientWidth, h: parseInt(n, 10) || e.offsetHeight || e.clientHeight };
      },
      N = function (e, t) {
        if (!e) return !1;
        if (!Array.isArray(e)) {
  ...
  function Mu() {
    var r = this,
      ...
      m = function (o, i, a, u, e) {
        var t, n;
        s[o] ||
          (0 !== (t = "string" == typeof i ? i : i.prefix + i.resource + i.suffix).indexOf("/") && -1 === t.indexOf("://") && (t = Mu.baseURL + "/" + t),
      ...
      e = function (e, t, n) {
        void 0 === n && (n = "added"), (he(c, e) && "added" === n) || (he(s, e) && "loaded" === n) ? t() : i.push({ name: e, state: n, callback: t });
      };
    return {
      items: o,
      urls: s,
  ...
  var Fu,
    ...
    ns = function (i, e) {
      var a = Ou({}),
        ...
        u = function (e, t) {
          var n = a.get(),
            r = t(n.hasOwnProperty(e) ? n[e] : { listeners: [], previous: Ou(U.none()) });
          (n[e] = r), a.set(n);
        },
        t = ju(function () {
          var e,
    ...
    ms = Math.round,
    ps = function (e) {
      return e ? { left: ms(e.left), top: ms(e.top), bottom: ms(e.bottom), right: ms(e.right), width: ms(e.width), height: ms(e.height) } : { left: 0, top: 0, bottom: 0, right: 0, width: 0, height: 0 };
    },
    gs = function (e, t) {
  ...
  var Vs,
    ...
    cc = function (e, t, n) {
      ...
      return m ? { name: (o = m.tagName), index: ic(n.dom, o, m) } : ((u = e), (c = t), (l = i), (f = (s = n).dom), ((d = {}).start = oc(f, u, c, l, !0)), s.isCollapsed() || (d.end = oc(f, u, c, l, !1)), d);
    },
    lc = function (e, t, n) {
    ...
    dc = function (e, t, n) {
      return 2 === t ? cc(po, n, e) : 3 === t ? ((o = (r = e).getRng()), { start: tc(r.dom.getRoot(), $s.fromRangeStart(o)), end: tc(r.dom.getRoot(), $s.fromRangeEnd(o)) }) : t ? { rng: e.getRng() } : fc(e, !1);
      var r, o;
    },
    mc = N(cc, o, !0),
    pc = Eu.DOM,
        ...
        show: function (t, e) {
          ...
          if (!a(e))
            return (
              ...
              Wc(u.nextSibling) ? (r.setStart(u, 0), r.setEnd(u, 0)) : (r.setStart(u, 1), r.setEnd(u, 1)),
              r
            );
  ...
  var hl,
    ...
    Of = function (e, t, n, r) {
      ...
      return (
        ...
        An(a) && a.hasChildNodes() && ((a = ws(a, t.collapsed ? u : u - 1)), In(a) && (u = a.nodeValue.length)),
        (o = xf(s, o)),
        (a = xf(s, a)),
        Df(o) && ((o = yf(o) ? o : o.parentNode), (o = t.collapsed ? o.previousSibling || o : o.nextSibling || o), In(o) && (i = t.collapsed ? o.length : 0)),
        Df(a) && ((a = yf(a) ? a : a.parentNode), (a = t.collapsed ? a.nextSibling || a : a.previousSibling || a), In(a) && (u = t.collapsed ? 0 : a.length)),
        t.collapsed &&
        ...
        (n[0].inline || n[0].block_expand) && ((n[0].inline && In(o) && 0 !== i) || (o = Tf(s, n, o, i, !0)), (n[0].inline && In(a) && u !== a.nodeValue.length) || (a = Tf(s, n, a, u, !1))),
        n[0].selector && !1 !== n[0].expand && !n[0].inline && ((o = _f(s, n, t, o, "previousSibling")), (a = _f(s, n, t, a, "nextSibling"))),
        (n[0].block || n[0].selector) && ((o = Af(e, n, o, "previousSibling")), (a = Af(e, n, a, "nextSibling")), n[0].block && (s.isBlock(o) || (o = Tf(s, n, o, i, !0)), s.isBlock(a) || (a = Tf(s, n, a, u, !1)))),
    ...
    ed = function (u, s, c, l) {
      u.undoManager.transact(function () {
        var e,
          ...
          i = o.getRng(),
          a = 0 < Ff(u).length;
        i.collapsed && !a && ((n = Of((e = u), (t = i), [{ inline: !0 }])), t.setStart(n.startContainer, n.startOffset), t.setEnd(n.endContainer, n.endOffset), e.selection.setRng(t)),
          o.getRng().collapsed && !a
            ? ((r = Qf(u.getDoc(), l, s, c.decorate)), as(r, lo), o.getRng().insertNode(r.dom), o.select(r.dom))
            : $f(o, !1, function () {
                qf(u, function (e) {
  ...
  var rd,
      ...
      var f,
        ...
        o = function (e) {
          ...
          C ||
            ...
            n((t = E.$(t).closest("table,img,figure.image,hr")[0]), R) && (a(), n(r.getStart(!0), t) && n(r.getEnd(!0), t)) ? u(t) : M());
        },
        i = function (e) {
    ...
    Cd = function (e) {
      var t = e.startContainer,
        ...
        r = e.endContainer,
        o = e.endOffset;
      return t === r && In(t) ? 0 < n && n < t.nodeValue.length && ((t = (r = bd(t, n)).previousSibling), n < o ? ((t = r = bd(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0)) : (o = 0)) : (In(t) && 0 < n && n < t.nodeValue.length && ((t = bd(t, n)), (n = 0)), In(r) && 0 < o && o < r.nodeValue.length && (o = (r = bd(r, o).previousSibling).nodeValue.length)), { startContainer: t, startOffset: n, endContainer: r, endOffset: o };
    };
  function wd(n) {
    return {
      walk: function (e, t) {
  ...
  var Sd,
    ...
    Pd = function (e, t) {
      var n = (function (e, t) {
          ...
          var r = n[n.length - 1];
          return Od(r) ? { element: e, offset: t } : "img" === Lt(r) ? { element: r, offset: 1 } : Ut(r) ? { element: r, offset: Gf(r).length } : { element: r, offset: Gt(r).length };
        })(e, t),
      ...
      n = function (f, e) {
        ...
        for (
          var t,
            ...
            N = 0,
            E = ci.decode,
            k = kt.makeMap("src,href,data,background,formaction,poster,xlink:href"),
          ...
          if ((x < t.index && T(E(w.substr(x, t.index - x))), (i = t[7]))) ":" === (i = i.toLowerCase()).charAt(0) && (i = i.substr(1)), R(i);
            ...
            if (!U || (s = K.getElementRule(i))) {
              if (
                ...
                if (((v = s.attributesRequired), (y = s.attributesDefault), (b = s.attributesForced), s.removeEmptyAttrs && !d.length && (c = !1), b)) for (r = b.length; r--; ) (a = (l = b[r]).name), "{$uid}" === (C = l.value) && (C = "mce_" + N++), (d.map[a] = C), d.push({ name: a, value: C });
  ...
  var rp,
      ...
      0 !== n &&
        ...
        e.replaceData(
          ...
          X(
            (s = i),
            function (e, t) {
              return Zl(t) || Ql(t) ? (e.previousCharIsSpace || ("" === e.str && c) || (e.str.length === s.length - 1 && l) ? { previousCharIsSpace: !1, str: e.str + lo } : { previousCharIsSpace: !0, str: e.str + " " }) : { previousCharIsSpace: !1, str: e.str + t };
            },
    ...
    rh = function (e, o, i, t) {
      ...
      return A(1)
        ? nh(E, k, _)
        : A(2)
        ? ((d = E), (m = k), (p = _), o.insertAfter(m.reverse(), d), th(m[0], p))
        : ((h = k),
          (v = _),
          (y = g = E),
          (C = (b = i).cloneRange()),
      ...
      return (
        ...
        U.from(u.getBody()).fold(E(s), function (e) {
          return ch(s)
            ...
            : ((t = u), (n = e), (o = c), 0 === (r = s).length || /^\s+$/.test(r) ? ((a = '<br data-mce-bogus="1">'), "TABLE" === n.nodeName ? (r = "<tr><td>" + a + "</td></tr>") : /^(UL|OL)$/.test(n.nodeName) && (r = "<li>" + a + "</li>"), (r = (i = vc(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), i.toLowerCase()) ? ((r = a), t.dom.createHTML(i, yc(t), r)) : r || '<br data-mce-bogus="1">'), lh(t, r), t.fire("SetContent", o)) : ("raw" !== o.format && (r = Jm({ validate: t.validate }, t.schema).serialize(t.parser.parse(r, { isRootContent: !0, insert: !0 }))), (o.content = so(At.fromDom(n)) ? r : kt.trim(r)), lh(t, o.content), o.no_events || t.fire("SetContent", o)), o.content);
          var t, n, r, o, i, a;
        })
      );
    },
    ...
    bh = function (e, t, n) {
      ...
      var r = e.dom,
        o = e.selection;
      if (t) yh(e, t, n);
      else if (!(t = Hl(e.getBody(), o.getStart()))) for (; (t = r.get(ph)); ) yh(e, t, !1);
    },
    Ch = function (e, t) {
    ...
    xh = function (e, t, n, r) {
      ...
      i &&
        (o
          ? ((a = y.getBookmark()), C.collapse(!0), (u = Of(e, C, e.formatter.get(t), !0)), (u = Cd(u)), e.formatter.remove(t, n, u, r), y.moveToBookmark(a))
          : ((s = Hl(e.getBody(), i)),
            (c = vh(!1).dom),
            (m = c),
            (p = null !== s ? s : i),
            (g = (d = e).dom),
            (h = g.getParent(p, N(of, d))) && g.isEmpty(h) ? p.parentNode.replaceChild(m, p) : (kp(At.fromDom(p)), g.isEmpty(p) ? p.parentNode.replaceChild(m, p) : g.insertAfter(m, p)),
  ...
  var Ah = kt.each,
        ...
        ? ((f = e),
          ...
          m.block &&
            (v
              ...
              : h.isBlock(d) && !h.isBlock(g) && ($h(h, d, !1) || $h(h, d.firstChild, !0, !0) || d.insertBefore(h.create("br"), d.firstChild), $h(h, d, !0) || $h(h, d.lastChild, !1, !0) || d.appendChild(h.create("br")))),
        ...
        r = function (e) {
          ...
          if (m.split) {
            if (((r = Cd(r)), (t = jh(s, r, !0)) !== (n = jh(s, r)))) {
              ...
              (t = Vh(a, t, "span", { id: "_start", "data-mce-type": "bookmark" })), (n = Vh(a, n, "span", { id: "_end", "data-mce-type": "bookmark" }));
              var i = a.createRng();
              i.setStartAfter(t),
                i.setEndBefore(n),
                Pf(a, i, function (e) {
          ...
          Pf(a, r, function (e) {
            W(e, function (t) {
              ...
              W(["underline", "line-through", "overline"], function (e) {
                An(t) && s.dom.getStyle(t, "text-decoration") === e && t.parentNode && df(a, t.parentNode) === e && Kh(s, { deep: !1, exact: !0, inline: "span", styles: { textDecoration: e } }, null, t);
              });
            });
          });
        };
    ...
    ev = function (E, k, _, r) {
          ...
          T(d),
            Pf(S, e, function (e) {
              var u,
                s = function (e) {
                  ...
                  if (
                    (An(e) && S.getContentEditable(e) && ((n = l), (l = "true" === S.getContentEditable(e)), (t = !0)),
                    zn(e) &&
                      !(function (e, t, n, r) {
            ...
            Qh(N, function (e) {
              ...
              (!(1 < N.length) && S.isBlock(e)) || 0 !== x
                ? (vf(R) || R.wrapper) &&
                  (R.exact || 1 !== x || ((C = w((y = e))) && !Jl(C) && Fm(S, C, R) && ((b = S.clone(C, !1)), T(b), S.replace(b, y, !0), S.remove(C, !0)), (e = b || y)),
                  Jh(E, A, _, e),
                  (p = R),
                  (g = k),
                  (h = _),
                  ...
                  (a = R).styles && (a.styles.color || a.styles.textDecoration) && (kt.walk(u, s, "childNodes"), s(u)),
                  (t = S),
                  (o = e),
                  ("sub" !== (r = R).inline && "sup" !== r.inline) || (Bh(o, Ph(t, "fontSize"), Lh(t, "fontSize", "")), t.remove(t.select("sup" === r.inline ? "sub" : "sup", o), !0)),
                  Oh(S, R, 0, e))
                : S.remove(e, !0);
            });
        };
      if ("false" !== a.getContentEditable(u.getNode())) {
        R &&
          (r
            ? tf(r)
              ? m(A, r) || ((e = a.createRng()).setStartBefore(r), e.setEndAfter(r), s(a, Of(E, e, A), 0, !0))
              : s(a, r, 0, !0)
            : i && vf(R) && !Ff(E).length
            ? (function (e, t, n) {
                var r,
    ...
    cv = function (e, t) {
      for (var n = e.rows, r = 0; r < n.length; r++) for (var o = n[r].cells, i = 0; i < o.length; i++) if (Ot(o[i], t)) return U.some({ x: i, y: r });
      return U.none();
    },
      ...
      return (
        kv(
          ...
          (c = function (e, t, n, r, o) {
            var i = l(e, t, n, r);
            if (null === i || (i.start === t && i.diag === t - r) || (i.end === e && i.diag === e - n)) for (var a = e, u = n; a < t || u < r; ) a < t && u < r && p[a] === g[u] ? (o.push([0, p[a]]), ++a, ++u) : r - n < t - e ? (o.push([2, p[a]]), ++a) : (o.push([1, g[u]]), ++u);
            else {
    ...
    Xv = function (e, t, n) {
      ...
      var r,
        o,
        i = ((r = t), ke(ke({ format: "html" }, n), { set: !0, selection: !0, content: r }));
        ...
        g = function (e, t) {
          ...
          if ((r = e) && (Gv(r) || (Jv(r.startContainer) && Jv(r.endContainer)))) {
            ...
            if (o) {
              ...
              e.collapsed || e.startContainer !== e.endContainer || !i.setBaseAndExtent || wt.ie || (e.endOffset - e.startOffset < 2 && e.startContainer.hasChildNodes() && (n = e.startContainer.childNodes[e.startOffset]) && "IMG" === n.tagName && (i.setBaseAndExtent(e.startContainer, e.startOffset, e.endContainer, e.endOffset), (i.anchorNode === e.startContainer && i.focusNode === e.endContainer) || i.setBaseAndExtent(n, 0, n, 1))), c.fire("AfterSetSelectionRange", { range: e, forward: t });
            }
          }
        },
        h = function () {
  ...
  var sy,
    ...
    $y = function (e, t, n, r, o) {
      var i,
        ...
        l,
        f,
        d = e ? { mobile: ((i = o.mobile || {}), (a = t), (u = { resize: !1, toolbar_mode: Hy(i, "scrolling"), toolbar_sticky: !1 }), ke(ke(ke({}, Fy), u), a ? { menubar: !1 } : {})) } : {},
        m = zy(["mobile"], Oy(d, o)),
        p = kt.extend(
          n,
          r,
          ...
          e && jy(f, "mobile")
            ...
            : {}),
          { validate: !0, external_plugins: ((s = r), (c = m.settings()), (l = c.external_plugins ? c.external_plugins : {}), s && s.external_plugins ? kt.extend({}, s.external_plugins, l) : l) }
        );
      return qy(e, m, r, p);
    },
    Wy = function (e, t, n, r, o) {
      var i,
        ...
        c =
          ...
          (a = Py),
          (u = e),
          (s = { id: t, theme: "silver", toolbar_mode: Hy(o, "floating"), plugins: "", document_base_url: i, add_form_submit_trigger: !0, submit_patch: !0, add_unload_trigger: !0, convert_urls: !0, relative_urls: !0, remove_script_host: !0, object_resizing: !0, doctype: "<!DOCTYPE html>", visual: !0, font_size_legacy_values: "xx-small,small,medium,large,x-large,xx-large,300%", forced_root_block: "p", hidden_input: !0, inline_styles: !0, convert_fonts_to_spans: !0, indent: !0, indent_before: "p,h1,h2,h3,h4,h5,h6,blockquote,div,title,style,pre,script,td,th,ul,ol,li,dl,dt,dd,area,table,thead,tfoot,tbody,tr,section,summary,article,hgroup,aside,figure,figcaption,option,optgroup,datalist", indent_after: "p,h1,h2,h3,h4,h5,h6,blockquote,div,title,style,pre,script,td,th,ul,ol,li,dl,dt,dd,area,table,thead,tfoot,tbody,tr,section,summary,article,hgroup,aside,figure,figcaption,option,optgroup,datalist", entity_encoding: "named", url_converter: u.convertURL, url_converter_scope: u }),
          ke(ke({}, s), a ? Fy : {}));
    ...
    Xy = function (e, t, n, r) {
      ...
      return "hash" === r
        ? ((a = {}),
          "string" == typeof (i = u)
            ? W(0 < i.indexOf("=") ? i.split(/[;,](?![^=;,]*(?:[;,]|$))/) : i.split(","), function (e) {
                var t = e.split("=");
    ...
    nb = function (e, t, n) {
      var r,
        ...
        h = ((o = e.inline), (a = t), (u = n), (s = (i = g).dom.getBoundingClientRect()), { x: a - (o ? s.left + i.dom.clientLeft + tb(i) : 0), y: u - (o ? s.top + i.dom.clientTop + eb(i) : 0) });
    ...
    yb = function (s) {
      var n,
        ...
        l =
          ...
          (i = function (e) {
            ...
            var t = e.id || vb("blobid"),
              n = e.name || t,
              r = e.blob;
            return { id: E(t), name: E(n), filename: E(e.filename || n + "." + ({ "image/jpeg": "jpg", "image/jpg": "jpg", "image/gif": "gif", "image/png": "png", "image/apng": "apng", "image/avif": "avif", "image/svg+xml": "svg", "image/webp": "webp", "image/bmp": "bmp", "image/tiff": "tiff" }[r.type.toLowerCase()] || "dat")), blob: E(r), base64: E(e.base64), blobUri: E(e.blobUri || URL.createObjectURL(r)), uri: E(e.uri) };
          }),
          {
        ...
        b = function (e, t) {
          ...
          v(e.src, t), s.$(e).attr({ src: s.getParam("images_reuse_filename", !1, "boolean") ? (n = t) + (-1 === n.indexOf("?") ? "?" : "&") + new Date().getTime() : t, "data-mce-src": r });
        },
        C = function (n) {
          return (
            (r = r || gb(f, { url: s.getParam("images_upload_url", "", "string"), basePath: s.getParam("images_upload_base_path", "", "string"), credentials: s.getParam("images_upload_credentials", !1, "boolean"), handler: s.getParam("images_upload_handler", null, "function") })),
            S().then(
              p(function (u) {
                    ...
                    var a = [],
                      t = z(e, function (e, t) {
                        var n,
                          ...
                          o = u[t].blobInfo,
                          i = u[t].image;
                        return e.status && s.getParam("images_replace_blob_uris", !0, "boolean") ? (l.removeByUri(i.src), b(i, e.url)) : e.error && (e.error.options.remove && (v(i.getAttribute("src"), wt.transparentSrc), a.push(i)), (n = s), (r = e.error.message), cb(n, Iu.translate(["Failed to upload image: {0}", r]))), { element: i, status: e.status, uploadUri: e.url, blobInfo: o };
                      });
                    return (
    ...
    Ab = function (n, r, o) {
      ...
      n.on("init", function () {
        ...
        n.on("keyup", function (e) {
          var t = e.keyCode;
          e.isDefaultPrevented() || (((33 <= t && t <= 36) || (37 <= t && t <= 40) || 45 === t || e.ctrlKey) && (a(), n.nodeChanged()), (46 !== t && 8 !== t) || n.nodeChanged(), i.get() && r.typing && !1 === Bv(Rv(n), r.data[0]) && (!1 === n.isDirty() && (n.setDirty(!0), n.fire("change", { level: r.data[0], lastLevel: null })), n.fire("TypingUndo"), i.set(!1), n.nodeChanged()));
        }),
      ...
      var e,
        ...
        l = function (e, t) {
          ...
          !(function (e) {
            ...
            ((n = a.getBody()),
            (r =
              !(Ob((o = e)) && !(Bb(o) || ("keyup" === o.type && 229 === o.keyCode))) &&
              (function (e, t, n) {
                if ($o(At.fromDom(t), !1)) {
                  var r = "" === n,
            ...
            (("" !== u.getAttrib(n, Db)) === r && !t) || (u.setAttrib(n, Db, r ? c : null), u.setAttrib(n, "aria-placeholder", r ? c : null), (i = r), a.fire("PlaceholderToggle", { state: i }), a.on(r ? "keydown" : "keyup", l), a.off(r ? "keyup" : "keydown", l)));
        };
      c &&
  ...
  var Mw,
    ...
    zw = function (e, t, n, r) {
      for (var o, i, a, u, s, c, l = _l(n), f = r, d = []; f && ((s = l), (c = f), (o = t === Vs.Forwards ? s.next(c) : s.prev(c))); ) {
        if (zn(o.getNode(!1))) return t === Vs.Forwards ? { positions: Uw(t, d).concat([o]), breakType: Cb.Br, breakAt: U.some(o) } : { positions: Uw(t, d), breakType: Cb.Br, breakAt: U.some(o) };
        if (o.isVisible()) {
          if (e(f, o)) {
  ...
  var Gw = function (o, i, a, e, u, t) {
    ...
    Ix = function (o, e) {
      return J(e, function (e) {
        var t,
          n,
          r = ((t = ps(e.getBoundingClientRect())), (n = -1), { left: t.left - n, top: t.top - n, right: t.right + 2 * n, bottom: t.bottom + 2 * n, width: t.width + n, height: t.height + n });
        return [
    ...
    Hx = function (e, t, n) {
      var r,
        ...
        a,
        u = e(t, n);
      return ((a = u).breakType === Cb.Wrap && 0 === a.positions.length) || (!zn(n.getNode()) && (i = u).breakType === Cb.Br && 1 === i.positions.length)
        ? ((r = e),
          (o = t),
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          Ox(
            [
              ...
              { keyCode: ud.RIGHT, ctrlKey: !o.isOSX(), altKey: o.isOSX(), action: Dx(lw, t, n) },
        ...
        /^(LI|DT|DD)$/.test(c) && f.isEmpty(s)
          ...
          : (N && s === a.getBody()) ||
            ...
            vo(s)
              ...
              ? v()
              : h(!0)
              ? ((n = s.parentNode.insertBefore(g(), s)), eS(a, sS(s, "HR") ? n : s))
              : ((S = (x = p).cloneRange()).setStart(x.startContainer, lS(!0, x.startContainer, x.startOffset)),
    ...
    KS = function (r) {
      r.on("keydown", function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = r),
          (n = e),
          Ox([{ keyCode: ud.SPACEBAR, action: Dx(WS, t) }], n).each(function (e) {
            n.preventDefault();
          }));
      });
    },
  ...
  var JS = function (e) {
          ...
          nN((a = t)) &&
            ...
            u.set({
              ...
              ghost: (function (e, t, n, r) {
                ...
                return o.setStyles(a, { position: "absolute", opacity: 0.5, overflow: "hidden", border: 0, padding: 0, margin: 0, width: n, height: r }), o.setStyles(i, { margin: 0, boxSizing: "border-box" }), a.appendChild(i), a;
      ...
      return (
        ...
        function (g) {
          return e.on(function (e) {
            ...
            e.dragging && ((d = e), (t = { pageX: (m = tN(h, g)).pageX - d.relX, pageY: m.pageY + 5 }), (l = e.ghost), (f = h.getBody()), l.parentNode !== f && f.appendChild(l), (n = e.ghost), (r = t), (o = e.width), (i = e.height), (a = e.maxX), (u = e.maxY), (c = s = 0), (n.style.left = r.pageX + "px"), (n.style.top = r.pageY + "px"), r.pageX + o > a && (s = r.pageX + o - a), r.pageY + i > u && (c = r.pageY + i - u), (n.style.width = o - s + "px"), (n.style.height = i - c + "px"), v(g.clientX, g.clientY));
          });
        }
      );
    },
      ...
      var s,
        ...
        C = function (e) {
          ...
          var r = (function (e, t, n) {
            ...
            o = At.fromDom(e);
          return (
            W(Gu(At.fromDom(u.getBody()), "*[data-mce-selected]"), function (e) {
              Ot(o, e) || Qn(e, i);
            }),
      ...
      return (
        ...
        wt.ie &&
          ...
          u.on("drop", function (e) {
            var t, n, r, o, i, a;
            h(e) || ((t = (i = e).dataTransfer && (a = i.dataTransfer.getData(p)) && 0 <= a.indexOf(m) ? ((a = a.substr(m.length).split(",")), { id: unescape(a[0]), html: unescape(a[1]) }) : null) && t.id !== u.id && (e.preventDefault(), (n = fd(e.x, e.y, u.getDoc())), d.setRng(n), (r = t.html), (o = !0), u.queryCommandSupported("mceInsertClipboardContent") ? u.execCommand("mceInsertClipboardContent", !1, { content: r, internal: o }) : u.execCommand("mceInsertContent", !1, r)));
          })),
        t &&
          (u.on("keydown", function (e) {
            if (!h(e) && e.keyCode === c) {
    ...
    xN = function (t, e) {
      ...
      (c.disabled = !0),
        ...
        t.readonly || (t.inline && "static" === hN.getStyle(c, "position", !0) && (c.style.position = "relative"), (c.contentEditable = t.getParam("content_editable_state", !0))),
        (c.disabled = !1),
        (t.editorUpload = yb(t)),
        (t.schema = Ci(n)),
        (t.dom = Eu(o, {
        ...
        (t.parser =
          ((i = by(yN((u = t)), u.schema)).addAttributeFilter("src,href,style,tabindex", function (e, t) {
    ...
    EN = function (e, t) {
      var n,
        ...
        u = ((n = e.id), (r = a), t.height, (o = e.getParam("iframe_attrs", {})), (i = At.fromTag("iframe")), Yn(i, o), Yn(i, { id: n + "_ifr", frameBorder: "0", allowTransparency: "true", title: r }), Wu(i, "tox-edit-area__iframe"), i.dom);
      u.onload = function () {
    ...
    ON = function (e) {
      ...
      e.fire("ScriptsLoaded"),
        ...
        (u = kc((i = e))),
        q(u) ? ((i.settings.theme = AN(u)), (a = ab.get(u)), (i.theme = new a(i, ab.urls[u])), i.theme.init && i.theme.init(i, ab.urls[u] || i.documentBaseUrl.replace(/\/$/, ""), i.$)) : (i.theme = {}),
        (s = e),
        (c = []),
      ...
      var p,
        ...
        h,
        v,
        y = { editorContainer: m.editorContainer, iframeContainer: m.iframeContainer };
    ...
    FN = function (e, t) {
      ...
      (n = s),
        ...
        (u = kc((r = e))),
        q(u)
          ? (PN(u) || ab.urls.hasOwnProperty(u) || ((a = r.getParam("theme_url")) ? ab.load(u, r.documentBaseURI.toAbsolute(a)) : ab.load(u, "themes/" + u + "/theme" + o + ".js")),
    ...
    UN = function (t) {
      ...
      Ti.Event.domLoaded
        ? t.getElement() &&
          ...
          (t.ui.styleSheetLoader = ((o = n), (i = t), Kr.forElement(o, { contentCssCors: i.getParam("content_css_cors"), referrerPolicy: wc(i) }))),
          ...
          (a = t.getElement().form || BN.getParent(e, "form")) &&
            ((t.formElement = a),
            t.getParam("hidden_input") && !Ln(t.getElement()) && (BN.insertAfter(BN.create("input", { type: "hidden", name: e }), e), (t.hasHiddenInput = !0)),
    ...
    GN = function (e, t) {
      var n,
        ...
        o,
        i,
        a = "string" != typeof (n = t) ? ((r = kt.extend({ paste: n.paste, data: { paste: n.paste } }, n)), { content: n.content, details: r }) : { content: n, details: {} };
      ...
      (tE.prototype.setupCommands = function (i) {
        ...
        this.addCommands({
          ...
          "Cut,Copy,Paste": function (e) {
            ...
            "paste" !== e || r.queryCommandEnabled(e) || (t = !0), (!t && r.queryCommandSupported(e)) || ((n = i.translate("Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X/C/V keyboard shortcuts instead.")), wt.mac && (n = n.replace(/Ctrl\+/g, "\u2318+")), i.notificationManager.open({ text: n, type: "error" }));
          },
          unlink: function () {
            var e;
  ...
  var mE,
    ...
    SE = function (t) {
      var e,
        n,
        r = Ou("design"),
        o = Ou({ design: { activate: V, deactivate: V, editorReadOnly: !1 }, readonly: { activate: V, deactivate: V, editorReadOnly: !0 } });
      return (
        (e = t).serializer
          ? sE(e)
    ...
    NE = kt.each,
    EE = kt.explode,
    kE = { f1: 112, f2: 113, f3: 114, f4: 115, f5: 116, f6: 117, f7: 118, f8: 119, f9: 120, f10: 121, f11: 122, f12: 123 },
    ...
    AE =
      ...
      (RE.prototype.createShortcut = function (e, t, n, r) {
        ...
        return (o[o.length - 1] = kt.extend(o[o.length - 1], { func: n, scope: r || this.editor })), kt.extend(o[0], { desc: this.editor.translate(t), subpatterns: o.slice(1) });
      }),
  ...
  function IE(e, t) {
    ...
    /^([\w\-]+):([^\/]{2})/i.test(e) || /^\s*#/.test(e)
      ...
      : ((n = 0 === e.indexOf("//")),
        ...
        /^[\w\-]*:?\/\//.test(e) || ((r = this.settings.base_uri ? this.settings.base_uri.path : new IE(document.location.href).directory), (e = this.settings.base_uri && "" == this.settings.base_uri.protocol ? "//mce_host" + u.toAbsPath(r, e) : ((o = /([^#?]*)([#?]?.*)/.exec(e)), ((a && a.protocol) || "http") + "://mce_host" + u.toAbsPath(r, o[1]) + o[2]))),
  ...
  var ME = Eu.DOM,
    ...
    HE =
      ...
      (VE.prototype.execCallback = function (e) {
        ...
        var r,
          o = this.settings[e];
        if (o) return this.callbackLookup && (r = this.callbackLookup[e]) && ((o = r.func), (r = r.scope)), "string" == typeof o && ((r = (r = o.replace(/\.\w+$/, "")) ? zE(r) : 0), (o = zE(o)), (this.callbackLookup = this.callbackLookup || {}), (this.callbackLookup[e] = { func: o, scope: r })), o.apply(r || this, t);
      }),
  ...
  function VE(e, t, n) {
    ...
    (this.plugins = {}),
      ...
      this.settings.referrer_policy && (Ru.ScriptLoader._setReferrerPolicy(this.settings.referrer_policy), Eu.DOM.styleSheetLoader._setReferrerPolicy(this.settings.referrer_policy)),
      (Uu.languageLoad = this.settings.language_load),
      (Uu.baseURL = n.baseURL),
      (this.id = e),
      this.setDirty(!1),
      (this.documentBaseURI = new LE(this.settings.document_base_url, { base_uri: this.baseUri })),
      ...
      (this.ui = { registry: TE(), styleSheetLoader: undefined, show: V, hide: V, enable: V, disable: V, isDisabled: C });
    var o = SE(this);
    (this.mode = o),
      (this.setMode = o.set),
  ...
  var qE,
    ...
    rk = ke(ke({}, gE), {
      ...
      add: function (e) {
        ...
        return (
          JE[e.id] === e ||
            (null === n.get(e.id) && ("length" !== e.id && (JE[e.id] = e), JE.push(e), QE.push(e)),
            ek(!0),
            (n.activeEditor = e),
    ...
    Ek =
      ...
      (kk.prototype.send = function (e) {
        ...
        (o.success = function (e, t) {
          ...
          (o.data = wk.serialize({ id: e.id || "c" + this.count++, method: e.method, params: e.params })),
  ...
  var Rk,
    Tk = {
      ...
      util: {
        ...
        Color: function (e) {
          ...
          return (
            ...
            (n.toHsv = function () {
              return (e = u), (t = s), (n = c), (o = 0), (i = yk((e /= 255), yk((t /= 255), (n /= 255)))), (a = bk(e, bk(t, n))), i === a ? { h: 0, s: 0, v: 100 * (o = i) } : ((r = (a - i) / a), { h: Ck(60 * ((e === i ? 3 : n === i ? 1 : 5) - (e === i ? t - n : n === i ? e - t : n - e) / ((o = a) - i))), s: Ck(100 * r), v: Ck(100 * o) });
              var e, t, n, r, o, i, a;
            }),
            (n.toHex = function () {
              var e = function (e) {
      ...
      dom: { EventUtils: Ti, Sizzle: Ta, DomQuery: hu, TreeWalker: Xr, TextSeeker: fs, DOMUtils: Eu, ScriptLoader: Ru, RangeUtils: xd, Serializer: Ny, StyleSheetLoader: $r, ControlSelection: cd, BookmarkManager: od, Selection: Qv, Event: Ti.Event },
      html: { Styles: xi, Entities: ci, Node: Km, Schema: Ci, SaxParser: ip, DomParser: by, Writer: Gm, Serializer: Jm },
      Env: wt,
      AddOnManager: Uu,
      Annotator: td,
      Formatter: _b,
