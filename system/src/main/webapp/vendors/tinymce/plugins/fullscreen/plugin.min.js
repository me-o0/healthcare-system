...
!(function () {
  ...
  var t,
          ...
          i = hn.throttle(function () {
            (document.body.scrollTop = 0),
              ...
              window.requestAnimationFrame(function () {
                r.on(function (n) {
                  return Z(n, { top: e.offsetTop + "px", left: e.offsetLeft + "px", height: e.height + "px", width: e.width + "px" });
                });
              });
          }, 50);
        return {
    ...
    An = function (e, r) {
      ...
      h
        ? (h.fullscreenChangeHandler.unbind(), pn(e) && yn(m) && ((u = W(m)), (i = u.dom).exitFullscreen ? i.exitFullscreen() : i.msExitFullscreen ? i.msExitFullscreen() : i.webkitCancelFullScreen && i.webkitCancelFullScreen()), (y.width = h.iframeWidth), (y.height = h.iframeHeight), (v.width = h.containerWidth), (v.height = h.containerHeight), (v.top = h.containerTop), (v.left = h.containerLeft), (o = h.scrollPos), window.scrollTo(o.x, o.y), r.set(null), gn(e, !1), b(), e.off("remove", b))
        : ((n = on(W(m), document.fullscreenElement !== undefined ? "fullscreenchange" : document.msFullscreenElement !== undefined ? "MSFullscreenChange" : document.webkitFullscreenElement !== undefined ? "webkitfullscreenchange" : "fullscreenchange", function (n) {
            pn(e) && (yn(m) || null === r.get() || An(e, r));
          })),
          (t = { scrollPos: { x: (l = an(window)).x, y: l.y }, containerWidth: v.width, containerHeight: v.height, containerTop: v.top, containerLeft: v.left, iframeWidth: y.width, iframeHeight: y.height, fullscreenChangeHandler: n }),
          p && kn(e.dom, s, g),
          ...
          e.on("remove", b),
          r.set(t),
          pn(e) && ((c = m.dom).requestFullscreen ? c.requestFullscreen() : c.msRequestFullscreen ? c.msRequestFullscreen() : c.webkitRequestFullScreen && c.webkitRequestFullScreen()),
          gn(e, !0));
    },
    Nn = function (t, r) {
      return function (e) {
