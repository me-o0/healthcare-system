...
!(function () {
  ...
  var e,
    ...
    P = function (o, e) {
      ...
      return (
        k({
          ...
          start: function (e, t) {
            if (!c.get())
              if (j(t.map, "data-ephox-embed-iri")) c.set(!0), (i = (n = t).map.style), (a = i ? T.parseStyle(i) : {}), (u = { type: "ephox-embed-iri", source: n.map["data-ephox-embed-iri"], altsource: "", poster: "", width: x(a, "max-width").map(C).getOr(""), height: x(a, "max-height").map(C).getOr("") });
              else {
    ...
    D = function (e) {
      var t = { mp3: "audio/mpeg", m4a: "audio/x-m4a", wav: "audio/wav", mp4: "video/mp4", webm: "video/webm", ogg: "video/ogg", swf: "application/x-shockwave-flash" }[e.toLowerCase().split(".").pop()];
      return t || "";
    },
        ...
        k(
          {
            ...
            start: function (e, t, r) {
              if (!m.get())
                if (j(t.map, "data-ephox-embed-iri")) m.set(!0), (n = c), (a = (i = t).map.style), ((o = a ? M.parseStyle(a) : {})["max-width"] = z(n.width)), (o["max-height"] = z(n.height)), N(i, { style: M.serializeStyle(o) });
                else {
                  switch (e) {
                    case "video":
                    case "object":
              ...
              if (!m.get()) {
                if ("video" === e && u)
                  for (var t, r = 0; r < 2; r++) {
                    c[U[r]] && (((t = []).map = {}), d <= r && (N(t, { src: c[U[r]], type: c[U[r] + "mime"] }), l.start("source", t, !0)));
                  }
                var n;
                c.poster && "object" === e && u && !s && (((n = []).map = {}), N(n, { src: c.poster, width: c.width, height: c.height }), l.start("img", n, !0));
              }
              l.end(e);
            },
          },
    ...
    L = function (t) {
      ...
      return 0 < e.length
        ? S.extend({}, e[0], {
            url: (function (e, t) {
              for (var r, n = (r = t.match(/^(https?:\/\/|www\.)(.+)$/i)) && 1 < r.length && "www." !== r[1] ? r[1] : "https://", i = e.regex.exec(t), a = n + e.url, o = 0; o < i.length; o++)
                !(function (e) {
    ...
    I = function (r, e) {
      ...
      return (
        ...
        "iframe" === n.type
          ? ((d = (m = n).allowFullscreen ? ' allowFullscreen="1"' : ""), '<iframe src="' + m.source + '" width="' + m.width + '" height="' + m.height + '"' + d + "></iframe>")
          : "application/x-shockwave-flash" === n.sourcemime
          ? ((l = '<object data="' + (s = n).source + '" width="' + s.width + '" height="' + s.height + '" type="application/x-shockwave-flash">'), s.poster && (l += '<img src="' + s.poster + '" width="' + s.width + '" height="' + s.height + '" />'), (l += "</object>"))
          : -1 !== n.sourcemime.indexOf("audio")
          ? ((c = n), (u = h) ? u(c) : '<audio controls="controls" src="' + c.source + '">' + (c.altsource ? '\n<source src="' + c.altsource + '"' + (c.altsourcemime ? ' type="' + c.altsourcemime + '"' : "") + " />\n" : "") + "</audio>")
          : "script" === n.type
          ? '<script src="' + n.source + '"></script>'
          : ((a = n), (o = f) ? o(a) : '<video width="' + a.width + '" height="' + a.height + '"' + (a.poster ? ' poster="' + a.poster + '"' : "") + ' controls="controls">\n<source src="' + a.source + '"' + (a.sourcemime ? ' type="' + a.sourcemime + '"' : "") + " />\n" + (a.altsource ? '<source src="' + a.altsource + '"' + (a.altsourcemime ? ' type="' + a.altsourcemime + '"' : "") + " />\n" : "") + "</video>")
      );
    },
    ...
    K = function (e) {
      var n = p(p({}, e), { source: { value: x(e, "source").getOr("") }, altsource: { value: x(e, "altsource").getOr("") }, poster: { value: x(e, "poster").getOr("") } });
      return (
    ...
    X = function (i, a) {
      return function (e) {
        var t, r, n;
        d(e.url) && 0 < e.url.trim().length && ((t = e.html), (r = V(a, t)), (n = p(p({}, r), { source: e.url, embed: t })), i.setData(K(n)));
      };
    },
    Y = function (e, t) {
    ...
    ee = function (m) {
      var e,
        ...
        u = [];
      m.getParam("media_alt_source", !0) && u.push({ name: "altsource", type: "urlinput", filetype: "media", label: "Alternative source URL" }), m.getParam("media_poster", !0) && u.push({ name: "poster", type: "urlinput", filetype: "image", label: "Media poster (Image URL)" });
      ...
      var h = { type: "tabpanel", tabs: l },
        f = m.windowManager.open({
          ...
          onChange: function (e, t) {
            switch (t.name) {
              case "source":
                (s = d.get()), (l = J(e.getData(), "source")), s.source !== l.source && (X(f, m)({ url: l.source, html: "" }), G(m, l).then(X(f, m))["catch"](Q(m)));
                break;
              case "embed":
        ...
        for (var t, r, n, i, a, o, c = e.length; c--; )
          (t = e[c]).parent &&
            (t.parent.attr("data-mce-object") ||
              ...
              "iframe" === t.name && u.getParam("media_live_embeds", !0) && re.ceFalse
                ? ae(t) ||
                  t.replace(
                    (function (e, t) {
                      var r = t.name,
                        n = new te("span", 1);
                      n.attr({ contentEditable: "false", style: t.attr("style"), "data-mce-object": r, class: "mce-preview-object mce-object-" + r }), ie(e, t, n);
                      var i = new te(r, 1);
                ...
                : ae(t) || t.replace(((n = u), (o = void 0), (a = (i = t).name), ((o = new te("img", 1)).shortEnded = !0), ie(n, i, o), o.attr({ width: i.attr("width") || "300", height: i.attr("height") || ("audio" === a ? "30" : "150"), style: i.attr("style"), src: re.transparentSrc, "data-mce-object": a, class: "mce-object mce-object-" + a }), o))));
      };
    },
    ce = function (e) {
      var t, r;
  ...
  n.add("media", function (e) {
    ...
    return (
        ...
        S.each("webkitallowfullscreen mozallowfullscreen allowfullscreen".split(" "), function (e) {
          ...
          d.serializer.addAttributeFilter("data-mce-object", function (e, t) {
            for (var r, n, i, a, o, c, u, s, l = e.length; l--; )
              if ((r = e[l]).parent) {
                for (u = r.attr(t), n = new te(u, 1), "audio" !== u && "script" !== u && ((s = r.attr("class")) && -1 !== s.indexOf("mce-preview-object") ? n.attr({ width: r.firstChild.attr("width"), height: r.firstChild.attr("height") }) : n.attr({ width: r.attr("width"), height: r.attr("height") })), n.attr({ style: r.attr("style") }), i = (a = r.attributes).length; i--; ) {
                  var m = a[i].name;
      ...
      r.on("ObjectResized", function (e) {
        var t,
          r = e.target;
        r.getAttribute("data-mce-object") && (t = r.getAttribute("data-mce-html")) && ((t = unescape(t)), r.setAttribute("data-mce-html", escape(E(t, { width: String(e.width), height: String(e.height) }))));
      }),
      (n = e),
      {
        showDialog: function () {
