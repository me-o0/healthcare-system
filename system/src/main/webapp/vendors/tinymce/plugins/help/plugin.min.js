...
!(function () {
  ...
  var e,
    ...
    v = function (e) {
      var n = k.mac ? { alt: "&#x2325;", ctrl: "&#x2303;", shift: "&#x21E7;", meta: "&#x2318;", access: "&#x2303;&#x2325;" } : { meta: "Ctrl ", access: "Shift + Alt " },
        t = e.split("+"),
        a = p(t, function (e) {
            ...
            html: [
              null == (n = e)
                ...
                : '<div data-mce-tabstop="1" tabindex="-1">' +
                      ...
                      i = p(o, function (e) {
                        return (
                          ...
                          g(C, function (e) {
                            ...
                            function (e) {
                              var t = e.slug || e.key;
                              return l({ name: e.name, url: "https://www.tiny.cloud/docs/plugins/" + t });
                            }
                          )) +
                          "</li>"
                        );
                  ...
                  "</div>",
              ((t = p(["Accessibility Checker", "Advanced Code Editor", "Advanced Tables", "Case Change", "Checklist", "Tiny Comments", "Tiny Drive", "Enhanced Media Embed", "Format Painter", "Link Checker", "Mentions", "MoxieManager", "Page Embed", "Permanent Pen", "PowerPaste", "Spell Checker Pro"], function (e) {
                return "<li>" + A.translate(e) + "</li>";
              }).join("")),
              '<div data-mce-tabstop="1" tabindex="-1"><p><b>' + A.translate("Premium plugins:") + "</b></p><ul>" + t + '<li class="tox-help__more-link" "><a href="https://www.tiny.cloud/pricing/?utm_campaign=editor_referral&utm_medium=help_dialog&utm_source=tinymce" target="_blank">' + A.translate("Learn more...") + "</a></li></ul></div>"),
            ].join(""),
          },
        ],
      };
    ...
    M = function (o, i) {
      return function () {
        ...
        o.windowManager.open({ title: "Help", size: "medium", body: n, buttons: [{ type: "cancel", name: "close", text: "Close", primary: !0 }], initialData: {} });
      };
    };
  a.add("help", function (e) {
    var t,
      ...
      l = M(e, (n = r));
    return (o = l), (a = e).ui.registry.addButton("help", { icon: "help", tooltip: "Help", onAction: o }), a.ui.registry.addMenuItem("help", { text: "Help", icon: "help", shortcut: "Alt+0", onAction: o }), (i = l), e.addCommand("mceHelp", i), e.shortcuts.add("Alt+0", "Open help dialog", "mceHelp"), s;
  });
})();
