...
!(function () {
    ...
    M = function (t, i) {
      ...
      return (
        L.each(t, function (t) {
          ...
          t.menu !== undefined ? ((e = M(t.menu, i)), u.push({ text: o, items: e })) : ((r = i(t)), u.push({ text: o, value: r }));
        }),
        u
      );
    },
    ...
    ut = function (t, n, e) {
      ...
      t.hasPlugin("rtc", !0)
        ? t.execCommand(
            ...
            (l = r.text),
            (c = r.title),
            j({ class: o.getOrNull(), href: i, rel: u.getOrNull(), target: a.getOrNull(), text: l.getOrNull(), title: c.getOrNull() }, function (t, n) {
              return !1 === f(t);
            }))
          )
        : ot(t, n, e);
    ...
    vt = function (u, a) {
      return R(
        [
          ...
          function (t) {
            var n = t.href;
            return (1 === e && !J(n)) || (0 === e && /^\s*www(\.|\d\.)/i.test(n))
              ? N.some({
    ...
    At = function (f, s) {
      return bt(f).then(function (t) {
        var n,
          ...
          a,
          l,
          c = ((e = s), (r = (n = f).dom), (o = tt(n) ? N.some(Y(n.selection, e)) : N.none()), (i = e ? N.some(r.getAttrib(e, "href")) : N.none()), (u = e ? N.from(r.getAttrib(e, "target")) : N.none()), (a = Nt(r, e, "rel")), (l = Nt(r, e, "class")), { url: i, text: o, title: Nt(r, e, "title"), target: u, rel: a, linkClass: l });
        return { anchor: c, catalogs: { targets: Ct(f), rels: Ot(f, c.target), classes: kt(f), anchor: yt(f), link: t }, optNode: N.from(s), flags: { titleEnabled: f.getParam("link_title", !0, "boolean") } };
      });
    },
    Pt = function (h) {
      var t, n;
          ...
          return (
            (e = function (t) {
              ...
              var n = function (n) {
                ...
                r = { href: e.url.value, text: n("text"), target: n("target"), rel: n("rel"), class: n("linkClass"), title: n("title") },
                o = { href: e.url.value, attach: e.url.meta !== undefined && e.url.meta.attach ? e.url.meta.attach : function () {} };
            ...
            (c = (n = u = t).anchor.text
              ...
              .toArray()),
            (f = n.flags.titleEnabled ? [{ name: "title", type: "input", label: "Title" }] : []),
            (s = N.from(p(r))),
            (o = s),
            (a = n.anchor),
            (m = { url: { value: (l = a.url.getOr("")), meta: { original: { value: l } } }, text: a.text.getOr(""), title: a.title.getOr(""), anchor: l, link: l, rel: a.rel.getOr(""), target: a.target.or(o).getOr(""), linkClass: a.linkClass.getOr("") }),
            (g = n.catalogs),
            (d = gt(m, g)),
            {
  ...
  o.add("link", function (t) {
    var n, e, r, i, o, u, a;
    (n = t).ui.registry.addToggleButton("link", { icon: "link", tooltip: "Insert/edit link", onAction: Dt(n), onSetup: Ut(n) }),
      n.ui.registry.addButton("openlink", { icon: "new-tab", tooltip: "Open link", onAction: Lt(n), onSetup: Bt(n) }),
      ...
      (e = t).ui.registry.addMenuItem("openlink", { text: "Open link", icon: "new-tab", onAction: Lt(e), onSetup: Bt(e) }),
      e.ui.registry.addMenuItem("link", { icon: "link", text: "Link...", shortcut: "Meta+K", onAction: Dt(e) }),
      ...
      (i = t).ui.registry.addContextForm("quicklink", {
        launch: { type: "contextformtogglebutton", icon: "link", tooltip: "Link", onSetup: Ut(i) },
        label: "Link",
                ...
                : ((n = { href: o, attach: function () {} }),
                  (e = tt(i)
                    ? N.some(Y(i.selection, r))
                        ...
                        .or(N.from(o))
                    : N.none()),
                  ut(i, n, { href: o, text: e, title: N.none(), rel: N.none(), target: N.none(), class: N.none() }),
                  t.hide());
            },
          },
          {
