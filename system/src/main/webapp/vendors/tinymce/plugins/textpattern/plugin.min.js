...
!(function () {
  ...
  var n,
        ...
        return o.replacement !== undefined
          ? g(o.replacement)
            ? 0 === o.start.length
              ...
              : B.value({ type: "inline-command", start: "", end: o.start, cmd: "mceInsertContent", value: o.replacement })
      ...
      return {
        ...
        getPatterns: function () {
          return (function () {
            ...
            for (var e = Array(t), o = 0, n = 0; n < r; n++) for (var a = arguments[n], i = 0, u = a.length; i < u; i++, o++) e[o] = a[i];
            return e;
    ...
    lt = function (t, n) {
      ...
      o).bind(function (t) {
        return Y(t) && (i < 0 || i > t.data.length) ? y.none() : y.some({ node: t, offset: i });
      });
    },
    dt = function (n, r) {
      ...
      return rt(e, t)
        ...
        .bind(function (n) {
          ...
          x(t, function (t) {
            ...
            return K.trim(o).length === t.start.length ? [] : [{ pattern: t, range: st(i.getRoot(), n, 0, n, 0) }];
          });
        })
        .getOr([]);
    },
    ...
    bt = function (t, n, r) {
      ...
      return { prefix: n, end: i.parentNode.insertBefore(vt(t, n + "-end"), i), start: u.parentNode.insertBefore(vt(t, n + "-start"), u) };
    },
    kt = function (t, n, r) {
    ...
    wt = function (a, i, u) {
      ...
      return it(l, d - u.pattern.end.length, i).bind(function (t) {
        ...
        if (nt(s)) return y.some({ matches: [{ pattern: s, startRng: e, endRng: e }], position: t });
        ...
        return (function (t, r, n, e, o, a) {
          ...
          return { matches: o.matches.concat([{ pattern: s, startRng: r, endRng: e }]), position: Q(t.startContainer, t.startOffset) };
        });
      });
    },
    ...
    Tt = function (f, t) {
      ...
      0 !== t.length &&
        ...
        w(r, function (t) {
          ...
          nt(t.pattern)
            ? ((n = f), (r = t.pattern), (e = t.endMarker), (o = u), (a = yt(n.dom, e)), $(n.dom, a, o), Et(n, r, a))
            : (function (t, n, r, e, o) {
                var a = t.dom,
                  i = yt(a, e),
                  u = yt(a, r);
    ...
    var n,
      ...
      e =
        ((n = (function (t) {
          ...
          if (!h(n)) return W("The setting textpattern_patterns should be an array"), { inlinePatterns: [], blockPatterns: [] };
          var r = S(O(n, _));
          return (
